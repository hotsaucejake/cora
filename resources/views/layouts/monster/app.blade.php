...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="/monster/assets/images/favicon.png">
    <title>Cora | Dashboard</title>
    <!-- Bootstrap Core CSS -->
    <link href="/monster/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <!-- chartist CSS -->
    <link href="/monster/assets/plugins/chartist-js/dist/chartist.min.css" rel="stylesheet">
    <link href="/monster/assets/plugins/chartist-js/dist/chartist-init.css" rel="stylesheet">
    <link href="/monster/assets/plugins/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.css" rel="stylesheet">
    <link href="/monster/assets/plugins/css-chart/css-chart.css" rel="stylesheet">
    <!-- Vector CSS -->
    <link href="/monster/assets/plugins/vectormap/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
    <!-- Calendar CSS -->
    <link href="/monster/assets/plugins/calendar/dist/fullcalendar.css" rel="stylesheet" />
    <!-- Custom CSS -->
    <link href="/monster/css/style.css" rel="stylesheet">
    <!-- You can change the theme colors from here -->
    <link href="/monster/css/colors/blue.css" id="theme" rel="stylesheet">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="#">
                        ...
                        <b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="/monster/assets/images/logo-icon.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="/monster/assets/images/logo-light-icon.png" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span>
                         <!-- dark Logo text -->
                         <img src="/monster/assets/images/logo-text.png" alt="homepage" class="dark-logo" />
                         <!-- Light Logo text -->    
                         <img src="/monster/assets/images/logo-light-text.png" class="light-logo" alt="homepage" /></span> </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                <!-- ============================================================== -->
                <div class="navbar-collapse">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="/monster/assets/images/users/1.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:30 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="/monster/assets/images/users/2.jpg" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Sonu Nigam</h5> <span class="mail-desc">I've sung a song! See you at</span> <span class="time">9:10 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="/monster/assets/images/users/3.jpg" alt="user" class="img-circle"> <span class="profile-status away pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Arijit Sinh</h5> <span class="mail-desc">I am a singer!</span> <span class="time">9:08 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="/monster/assets/images/users/4.jpg" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:02 AM</span> </div>
                                            </a>
                                        </div>
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid" src="/monster/assets/images/big/img1.jpg" alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="/monster/assets/images/big/img2.jpg" alt="Second slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="/monster/assets/images/big/img3.jpg" alt="Third slide"></div>
                                                </div>
                                            </div>
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="/monster/assets/images/users/1.jpg" alt="user" class="profile-pic" /></a>
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="/monster/assets/images/users/1.jpg" alt="user"></div>
                                            <div class="u-text">
                                                <h4>Steave Jobs</h4>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile">
                    <!-- User profile image -->
                    <div class="profile-img"> <img src="/monster/assets/images/users/1.jpg" alt="user" /> </div>
                    <!-- User profile text-->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="table browser m-t-30 no-border">
                                    <tbody>
                                        <tr>
                                            <td style="width:40px"><img src="/monster/assets/images/browser/chrome-logo.png" alt=logo /></td>
                                            <td>Google Chrome</td>
                                            <td class="text-right"><span class="label label-light-info">23%</span></td>
                                        </tr>
                                        <tr>
                                            <td><img src="/monster/assets/images/browser/firefox-logo.png" alt=logo /></td>
                                            <td>Mozila Firefox</td>
                                            <td class="text-right"><span class="label label-light-success">15%</span></td>
                                        </tr>
                                        <tr>
                                            <td><img src="/monster/assets/images/browser/safari-logo.png" alt=logo /></td>
                                            <td>Apple Safari</td>
                                            <td class="text-right"><span class="label label-light-primary">07%</span></td>
                                        </tr>
                                        <tr>
                                            <td><img src="/monster/assets/images/browser/internet-logo.png" alt=logo /></td>
                                            <td>Internet Explorer</td>
                                            <td class="text-right"><span class="label label-light-warning">09%</span></td>
                                        </tr>
                                        <tr>
                                            <td><img src="/monster/assets/images/browser/opera-logo.png" alt=logo /></td>
                                            <td>Opera mini</td>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    <div class=""><img src="/monster/assets/images/users/1.jpg" alt="user" class="img-circle" width="100"></div>
                                    <div class="p-l-20">
                            ...
                            <div class="card-body">
                                <div class="row text-center">
                                    <div class="col-12 m-b-30">
                                        <h4>Followers</h4></div>
                                    <div class="col"><span class="round" data-toggle="tooltip" title="Varun"><img src="/monster/assets/images/users/4.jpg" alt="user" width="45"/></span></div>
                                    <div class="col"><span class="round" data-toggle="tooltip" title="Alia"><img src="/monster/assets/images/users/2.jpg" alt="user" width="45"/></span></div>
                                    <div class="col"><span class="round" data-toggle="tooltip" title="Akshay"><img src="/monster/assets/images/users/3.jpg" alt="user" width="45"/></span></div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="chat-box">
                                    ...
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        <li>
                                            <div class="chat-img"><img src="/monster/assets/images/users/1.jpg" alt="user" /></div>
                                        ...
                                        <!--chat Row -->
                                        <li>
                                            <div class="chat-img"><img src="/monster/assets/images/users/2.jpg" alt="user" /></div>
                                            <div class="chat-content">
                                                <h5>Bianca Doe</h5>
                                        ...
                                        <!--chat Row -->
                                        <li>
                                            <div class="chat-img"><img src="/monster/assets/images/users/3.jpg" alt="user" /></div>
                                            <div class="chat-content">
